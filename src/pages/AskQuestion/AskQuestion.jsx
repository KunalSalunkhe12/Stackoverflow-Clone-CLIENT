...
const AskQuestion = () => {
    ...
    const handleSubmit = (e)=>{
        ...
        console.log({questionBody, questionTitle, questionTags, user: User.result.name, id: User.result._id })
    }
                ...
                <form onSubmit={handleSubmit}>
                    <div className="ask-form-container">
                        ...
                        <label htmlFor="ask-ques-body">
                            ...
                            <textarea name="" id="ask-ques-body"  cols="30" rows="10" onChange={e=>{setQuestionBody(e.target.value)}} onKeyDown={handleKeyDown}></textarea>
                        </label>
